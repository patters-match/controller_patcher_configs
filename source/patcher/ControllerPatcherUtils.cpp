...
f32 ControllerPatcherUtils::convertAnalogSignedValue(s16 value, s16 default_val, s16 min, s16 max, u8 invert, s16 deadzone) {
    f32 new_value = (f32)(value - default_val);
    f32 range = 0.0f;
